      ...
      <div className=" text-white relative px-4 ml-5 md:mr-28 mr-16 container">
        ...
        <div className="space-y-4">
          ...
          <p className=" leading-loose">
            ...
            that well-crafted instruments play in these settings. Our products
            are made from long-lasting materials, ensuring reliable performance
            in demanding environments. we believe that the right tools can make
